...
However, recall that we selected the top 3% of the probability mass, so within the orange interval, the area under the curve must be $0.03$, and therefore the value of the density must be $1$ on average within the orange interval.
...
[^1]: This feels like it could be a circular argument to me. It's also not necessary: once we know $F_Y(Y)$, we know the distribution of $Y$. I still found it instructive to do work through these steps.