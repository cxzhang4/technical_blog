...
For extra reading and formalism, we use the above insight to define the following lemma.

**Lemma:** For all real numbers $a, b$ such that $0 \leq a < b \leq 1$, $Y = F_X(X) \sim \text{Uniform}(0, 1)$.
